...
climate_starter.ipynb: notebook to perform basic data analysis of sqlite files
app.py: script to run api based on ipynb and sqlite with multiple paths to return different metrics related to the weather measurements
